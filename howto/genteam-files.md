...
- There's no download button in this tab for now; to take a file out, have the agent send it as an attachment to a group chat/DM
...
Two places: the group chat's **Files** tab rounds up all of that group chat's attachments; or use in-chat search (the search icon in the group chat header), which has a dedicated Files tab for searching by file.
